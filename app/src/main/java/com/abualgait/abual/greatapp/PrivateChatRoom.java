...
public class PrivateChatRoom extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.menu_sign_out) {
            ...
            Toast.makeText(PrivateChatRoom.this, "You have been signed out.", Toast.LENGTH_LONG).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (b != null) {
            theemail = (String) b.get("theemail");
            Toast.makeText(getApplicationContext(), theemail, Toast.LENGTH_SHORT).show();
        }
        ...
        toolbar.setTitle(theemail); // set Title for Toolbar
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FirebaseDatabase.getInstance().getReference().push().setValue(new ChatMessage(input.getText().toString(), FirebaseAuth.getInstance().getCurrentUser().getEmail(), url));
  ...
  */
    ...
    public void displayChatMessages(final String email) {
        ...
        adapter = new FirebaseListAdapter<ChatMessage>(this, ChatMessage.class, R.layout.message, FirebaseDatabase.getInstance().getReference()) {
            ...
            protected void populateView(View v, ChatMessage model, int position) {
                ...
                if (model.getMessageUser().equals(email)
                        ||model.getMessageUser().equals(FirebaseAuth.getInstance().getCurrentUser().getEmail())) {
